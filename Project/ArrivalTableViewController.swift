...
class ArrivalTableViewController: UITableViewController , NSFetchedResultsControllerDelegate {
    ...
    private var cities = [ArrivalCity]()
    private var searchController = UISearchController()
    private var searchResults: [ArrivalStation]? = nil
    ...
    override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        if !searchController.active {
            let stations = Array(cities[indexPath.section].stations!) as! [ArrivalStation]
    ...
    private func setFetchedResultController() {
        ...
        cities = fetchedResultController.fetchedObjects as! [ArrivalCity]
    ...
    private func cityFetchResult() -> NSFetchRequest {
        let fetchRequest = NSFetchRequest(entityName: "ArrivalCity")
    ...
    private func stationFetchResult() -> NSFetchRequest {
        let fetchRequest = NSFetchRequest(entityName: "ArrivalStation")
...
extension ArrivalTableViewController {
    ...
    override func tableView(tableView: UITableView, didSelectRowAtIndexPath indexPath: NSIndexPath) {
        ...
        if !searchController.active {
            guard let stations = Array(cities[indexPath.section].stations!) as? [ArrivalStation] else { return }
            ...
            infoController.arrivalStation = currentStation
        } else {
...
extension ArrivalTableViewController: UISearchControllerDelegate, UISearchBarDelegate, UISearchResultsUpdating  {
